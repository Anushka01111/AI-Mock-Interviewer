...
try:
    ...
    print(f"[WARNING] spaCy model not available ({e}). Using regex-based keyword extraction.")

sbert_model = SentenceTransformer("all-MiniLM-L6-v2")

# Basic stopword list for the regex fallback (spaCy normally handles this)
_STOPWORDS = {
    "the", "a", "an", "and", "or", "but", "in", "on", "at", "to", "for",
    "of", "with", "is", "are", "was", "were", "be", "been", "being",
    "this", "that", "these", "those", "it", "its", "i", "you", "we",
    "they", "he", "she", "as", "by", "from", "has", "have", "had"
}
...
def extract_keywords(text: str) -> set[str]:
    """
    Extract key terms from text. Uses spaCy (nouns/proper nouns) if available,
    otherwise falls back to simple regex word extraction minus stopwords.
    """
    ...
    # Fallback: extract words of length > 2, lowercase, minus stopwords
